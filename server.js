...
app.post('/upload', function (req, res) {
	...
	var sql2 = "insert into upload values ('" + files.filetoupload.name + "','" + comment + "')";
	con.query(sql2, function(err, result) {
		if (err) throw err;
	});
	con.end();
