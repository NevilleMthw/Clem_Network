...
app.get( '/profile', handleGetRequest );
app.use( express.static( 'public' ) );
app.use( express.static( 'templates' ) );
var home = "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta content='width=&lt;device-width&gt;, initial-scale=1.0' name='viewport'> <link href='../style.css' rel='stylesheet' type='text/css'> <title>Clem_Network</title> <script src='https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js'> </script> </head> <body> <div class='navigation'> <nav> <ul> <li> <a onclick='homeStart()'>Home</a> </li><li> <a onclick='accountStart()'>Login/Register</a> </li> <li> <a onclick= 'post()'>Post</a> </li> <li> <a onclick = 'display()'>Feed</a> </li> </ul> </nav> </div> <div class='con'> <div class='intro'> <h1>HELLO!</h1> <p>Welcome to The Clem_Network.</p> </div> <div class='about-us'> <div class='con'> <div class='about_us'> <h1>ABOUT THE WEBSITE</h1> <p>This website was based off of the original Clem character from a game called Warframe. This is a full fledged single page social media website where one can post about their day and more. Hope you like it!</p> </div> </div> </div> </div> </body> </html>";
var loginregister = "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta content='width=&lt;device-width&gt;, initial-scale=1.0' name='viewport'> <link href='../public/style.css' rel='stylesheet' type='text/css'> <title>LOGIN/REGISTER</title> </head> <body> <div class='navigation'> <nav> <ul> <li> <a onclick='homeStart()'>Home</a> </li> <li> <a onclick='accountStart()'>Login/Register</a> </li> <li> <a onclick='post()'>Post</a> </li> <li> <a onclick='display()'>Feed</a> </li> </ul> </nav> </div> <div class='container'> <div class='container-forms'> <div class='container-info'> <div class='info-item'> <div class='table'> <div class='table-cell'> <p> Interesting. </p> <div class='btn'> Login </div> </div> </div> </div> <div class='info-item'> <div class='table'> <div class='table-cell'> <p> BECOME AWESOME. </p> <div class='btn'> Register </div> </div> </div> </div> </div> <div class='container-form'> <div class='form-item log-in'> <div class='table'> <div class='table-cell'> <input name='Username' id = 'user' placeholder='Username' type='text' /><input name='Password' id = 'pass' placeholder='Password' type='Password' /> <button class='loginregister' onclick='login()'>Login</button> </div> </div> </div> <div class='form-item sign-up'> <div class='table'> <div class='table-cell'> <input name='Username' id = 'user1' placeholder='Username' type='text' /><input name='Password' id = 'pass1' placeholder='Password' type='Password' /> <button class = 'loginregister' onclick='register1()'>Register</button> </div> </div> </div> </div> </div> </div> </body> </html>";
var post = "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta content='width=device-width, initial-scale=1.0' name='viewport'> <link href='../public/style.css' rel='stylesheet' type='text/css'> <title>Post</title> </head> <body> <div class='navigation'> <nav> <ul> <li> <a onclick='homeStart()'>Home</a> </li> <li> <a onclick='accountStart()'>Login/Register</a> </li> <li> <a onclick='post()'>Post</a> </li> <li> <a onclick='display()'>Feed</a> </li> </ul> </nav> </div> <div class='con'> <h3 id = 'uploadTitle'>POST IT ALL HERE!</h3> <form action='upload' enctype='multipart/form-data' method='post'> <input name='filetoupload' id = 'uploadFile' type='file'><br> <h3 id= 'caption'>Enter Caption &#128513;</h3> <input name='desc' id = 'uploadText' type='text'><br> <input type = 'submit' id = 'uploadButton' onclick='setTimeout(displayUsername,100)'/> </form> </div> </body> </html>";
var profile = "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta name='viewport' content='width=device-width, initial-scale=1.0'> <link href='../public/style.css' rel='stylesheet' type='text/css'> <title>Profile</title> </head> <body> <div class='navigation'> <nav> <ul> <li> <a onclick='homeStart()'>Home</a> </li> <li> <a onclick='accountStart()'>Login/Register</a> </li> <li> <a onclick= 'post()'>Post</a> </li> <li> <a onclick = 'display()'>Feed</a> </li> </ul> </nav> </div> <h3 id = 'logoutTitle'>LEAVING SO SOON?</h3> <button id = 'logout' onclick='logout()'>LOGOUT</button> </body> </html>";
...
function displayPosts( request, response ) {
  ...
  con.query( sql3, function( err, result ) {
    ...
    var inputs = "";
    result.forEach( function( u ) {
      inputs += '<div><img class = "postPic" src = "../images/' + u.path + '"></div><p class = "postUsername">' + u.username + '</p><p class="postComment">' + u.comment + '</p> </body></html>';
    } )
    var display = '';
...
function displaySearch( request, response ) {
  ...
  con.query( sql3, function( err, result ) {
    ...
    var inputs = "";
    result.forEach( function( u ) {
      inputs += '<div><img class="postPic" src = "../images/' + u.path + '"></div><p class= "postUsername">' + u.username + '</p><p class ="postComment">' + u.comment + '</p>';
    } )
    var display = '';
    display = "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta name='viewport' content='width=device-width, initial-scale=1.0'> <link href='../public/style.css' rel='stylesheet' type='text/css'> <title>Post</title> </head> <body> <body> <div class='navigation'> <nav> <ul> <li> <a onclick='homeStart()'>Home</a> </li> <li> <a onclick='accountStart()'>Login/Register</a> </li> <li> <a onclick= 'post()'>Post</a> </li> <li> <a onclick='display()'>Feed</a> </li> </ul> </nav> </div><h3 class = 'searchTitle'>FEED</h3><input type = 'text' id= 'searchBar'/><br><input type='submit' class= 'searchButton' onclick = 'searchFunc()'/></body></html>";
    display = display + inputs;
